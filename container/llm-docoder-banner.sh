...
echo " Clipboard: OpenCode 复制需要终端支持 OSC 52"
echo "            Recommend: iTerm2 / Windows Terminal / WezTerm / Kitty / Ghostty / Alacritty"
echo "            tmux inside container is pre-configured for passthrough"
echo "============================================================"
echo ""
